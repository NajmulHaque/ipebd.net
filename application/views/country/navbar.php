      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo site_url();?>Home/addUniversity/">ADD University</a></li>
            <li><a href="#">List University</a></li>
            <li><a href="<?php echo site_url();?>Home/addCountry">Add Country</a></li>
