...
<div class="container">
  ...
  <div class="col-md-2"> </div>
      ...
      <div class="col-md-5 ebl-depositbox">
       <h2>Add New Deposit to EBL CARD</h2>

                    <form method="post" action="<?php echo site_url('Test/save_ebl_deposit');?>">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Amount" name="ebl_d_amount">
                      </div>
